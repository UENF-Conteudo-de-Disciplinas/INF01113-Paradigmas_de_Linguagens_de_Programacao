...
plot2d(t , [f g]);
legends(['f = 2*sin(t)';'g=2*cos(t)'],[1 2],opt="ur"); // ul, ll,lr

da=gca();
da.title.font_size = 5;
da.title.font_foreground = 5;    // 5=vermelho
da.title.text="Gráficos de f = 2*sin(t)  e   g = 2*cos(t)";
