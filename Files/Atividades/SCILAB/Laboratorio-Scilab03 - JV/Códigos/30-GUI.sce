...
T31 = uicontrol(h,                                          ...
  ...
  'string',                                                 ...
  ' Vermelho | Azul | Verde | Laranja | Preto | Amarelo ',  ... //abaixo outra forma
  'fontsize', 15,                                           ...
  'backgroundcolor', [1 1 1]                                ...
  );   // branco
...
slider_frame_title = uicontrol(h,        ...
  "Position", [475 300 70 20],           ...
  "Style", "text",                       ...
