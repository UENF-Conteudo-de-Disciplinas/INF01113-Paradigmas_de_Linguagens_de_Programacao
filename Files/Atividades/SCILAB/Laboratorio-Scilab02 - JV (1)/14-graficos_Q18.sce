...
da1.title.text="sin(2*x)**2+2";
da1.x_label.text="Tempo"; 
da1.x_location='middle'; 
da1.y_label.text="sin(2*x)**2+2"; 
...
da2.title.text="cos(x/2)**2+2";
da2.x_label.text="Tempo"; 
da2.x_location='middle'; 
da2.y_label.text="cos(x/2)**2+2"; 
...
da3.title.text="sin(x)**2 + cos(x)**2";
da3.x_label.text="Tempo"; 
da3.x_location='middle'; 
da3.y_label.text="sin(x)**2 + cos(x)**2"; 
