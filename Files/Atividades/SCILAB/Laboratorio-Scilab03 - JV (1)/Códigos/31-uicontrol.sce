...
set( ...
  E2, 'string', ' Janeiro | Fevereiro | Março | Abril | Maio | Junho |' ...
...
//dia
T3 = uicontrol( ...
  h, 'style', 'text', 'string', 'Digite o dia:', ..
  'position', [20 160 200 50], 'backgroundcolor', [0.7 0.9 1] ...
  );

E3 = uicontrol( ...
  h, 'style', 'edit', 'string', '07', ..
...
P1 = uicontrol( ...
  h, 'position', [350 270 180 40], ...
  'style', 'pushbutton', ...
  'string', 'Pressione aqui ', ...   // botão para pressionar
