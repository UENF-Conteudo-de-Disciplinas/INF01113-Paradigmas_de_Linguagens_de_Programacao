...
function ASCV_Sobre()
  msg = msprintf(gettext(...
    "Interface Adaptada na UENF (CCT - LCMAT - CC)" + ...
...
//----------------------------------
hd1=uicontrol(...
  'Parent',h0,'style','pushbutton','string'," Função:", ...
  'callback',"deriv",'Position',[20,500,80,20], 'backgroundcolor', [0 1 0] ...
  );
Equation=" Y = ";
he =uicontrol( ...
  'Parent',h0,'style','text','string', ...
  Equation,'Position',[70,460,320,30],'FontWeight','bold','FontSize',15 ...
  );

//----------------------- Coeficiente A -------------              
h1t=uicontrol( ...
  'Parent',h0,'style','text','string'," Coeficiente A",'Position',[20,430,70,20] ...
  );
h1 =uicontrol(...
  'Parent',h0,'style','slider','MIN',-50,'Max',50,'Position',[20,410,420,20],...
  'callback',"graphe"...
  );
h1r=uicontrol(...
  'Parent',h0,'style','pushbutton','string', ...
  "Reset",'callback',"R_A",'Position',[380,430,60,20] ...
  );
h1v=uicontrol( ...
  'Parent',h0,'style','text','string'," "+string(h1.value),...
  'Position',[210,430,35,20],'FontWeight','bold','FontSize',15 ...
  );

//----------------------- Coeficiente B -------------     
h2t=uicontrol( ...
  'Parent',h0,'style','text','string'," Coeficiente B",'Position',[20,370,70,20] ...
  );
h2 =uicontrol( ...
  'Parent',h0,'style','slider','MIN',-50,'Max',50,'Position',[20,350,420,20], 'callback',"graphe" ...
  );
h2r=uicontrol( ...
  'Parent',h0,'style','pushbutton','string',"Reset",'callback',"R_B",'Position',[380,370,60,20] ...
  );
h2v=uicontrol( ...
  'Parent',h0,'style','text','string'," "+string(h2.value), ...
  'Position',[210,370,35,20],'FontWeight','bold','FontSize',15 ...
  );

//----------------------- Coeficiente C -------------    
h3t=uicontrol( ...
  'Parent',h0,'style','text','string'," Coeficiente C",'Position',[20,310,70,20] ...
  );
h3 =uicontrol( ...
  'Parent',h0,'style','slider','MIN',-50,'Max',50,'Position',[20,290,420,20],'callback',"graphe" ...
  ); 
h3r=uicontrol( ...
  'Parent',h0,'style','pushbutton','string',"Reset",'callback',"R_C",'Position',[380,310,60,20] ...
  );
h3v=uicontrol( ...
  'Parent',h0,'style','text','string'," "+string(h3.value), ...
  'Position',[210,310,35,20],'FontWeight','bold','FontSize',15 ...
  );

//----------------------- Coeficiente D -------------     
h4t=uicontrol( ...
  'Parent',h0,'style','text','string'," Coeficiente D",'Position',[20,250,70,20] ...
  );
h4 =uicontrol( ...
  'Parent',h0,'style','slider','MIN',-50,'Max',50,'Position',[20,230,420,20],...
  'callback',"graphe" ...
  );
h4r=uicontrol( ...
  'Parent',h0,'style','pushbutton','string',"Reset",'callback',"R_D",'Position',[380,250,60,20] ...
  );
h4v=uicontrol( ...
  'Parent',h0,'style','text','string'," "+string(h4.value), ...
  'Position',[210,250,35,20],'FontWeight','bold','FontSize',15 ...
  );
//---------------------------------------------------    
hd2=uicontrol( ...
  'Parent',h0,'style','pushbutton','string'," Gráfico da Derivada",...
  'callback',"deriv",'Position',[20,150,150,20], 'backgroundcolor', [1 1 0] ...
  );
EquationDer=" Y'' = ";
hder=uicontrol( ...
  'Parent',h0,'style','text','string',EquationDer, ...
  'Position',[70,110,320,30],'FontWeight','bold','FontSize',15 ...
  );
