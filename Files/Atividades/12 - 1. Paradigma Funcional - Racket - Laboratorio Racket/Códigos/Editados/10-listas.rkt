...
(define D (append A B))
;;--------------------------------------
(display "Lista A = ")                A               (newline)
(display "Lista B = ")                B               (newline)
(display "Lista C = (list A B)= ")    C               (newline)
(display "Lista D = (append A B)= ")  D               (newline)
(display "Lista D reversa = ")        (reverse D)     (newline)  ; lista inversa
(display "Comprimento da lista B = ") (length B)      (newline)  ; comprimento de uma lista
;;------------ primeiro elemento e Resto da lista -----------------
(display "PRIMEIRO elemento da lista B = ")   (car B)         (newline)
(display "RESTO da lista B = ")               (cdr B)         (newline)