...
;;----------------------------
(newline)
(display "MinQadrado de 6 e 9 = ")    (minquadrado 6 9) (newline)
(display "Oi pessoal da UENF! ")      (reply "Oi pessoal da UENF!")
(display "Vai chover na madrugada? ") (reply "Vai chover na madrugada?")