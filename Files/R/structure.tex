...
\hypersetup{
  ...
  pdfauthor={João Vítor Fernandes Dias},                  % author
  pdfsubject={Paradigmas de Linguagens de Programação},   % subject of the document
  pdfcreator={JVFD, WinEdt},                              % creator of the document
  pdfproducer={JVFD},                                     % producer of the document
  pdfkeywords={Programação} {Dados} {Paradigmas},         % list of keywords
...
%PACOTES JOÃO VÍTOR FERNANDES DIAS 2021
\usepackage{listings}